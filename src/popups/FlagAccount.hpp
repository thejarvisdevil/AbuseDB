...
class FlagAccount : public Popup<> {
    int m_accountID{ 0 };
    ...
    bool setup() override {
        ...
        sendButton = CCMenuItemSpriteExtra::create(
            ...
            this, menu_selector(FlagAccount::onSend)
        );
    ...
    void onSend(CCObject*) {
        ...
        req.header("Content-Type", "application/x-www-form-urlencoded")
           .bodyString(fmt::format("account_id={}&reason={}&password={}",
                                   m_accountID,
                                   reason, password));
        ...
        m_flagListener.setFilter(req.post("https://api.jarvisdevil.com/abusedb/flagAccountGeode.php"));
    }

public:
    static FlagAccount* create(int accountID) {
        auto ret = new FlagAccount();
